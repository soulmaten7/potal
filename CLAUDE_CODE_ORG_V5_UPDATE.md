...
> **날짜**: 2026-03-23 KST
> **파일 위치**: `/Users/maegbug/portal/POTAL_AI_Agent_Org_v4.html` (⚠️ 이 파일이 반드시 존재함. 확인: `ls -la /Users/maegbug/portal/POTAL_AI_Agent_Org_v4.html`)
> **출력**: `/Users/maegbug/portal/POTAL_AI_Agent_Org_v5.html` (새 파일로 저장, v4는 보존)
...
```bash
ls -la /Users/maegbug/portal/POTAL_AI_Agent_Org_v4.html
```
...
수정 완료 후 `/Users/maegbug/portal/POTAL_AI_Agent_Org_v5.html`로 저장.
기존 v4 파일은 삭제하지 않음.
