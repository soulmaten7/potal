#!/usr/bin/env python3
"""
Hybrid v8: v2 structure + GPT-4o (no feedback)
...
OUTPUT_FILE = "/Volumes/soulmaten/POTAL/benchmark/results/hybrid_v8_results.json"
...
def stage3_national_line(name, desc, h6, entries_in_chapter):
    ...
    prompt = f"""Pick the single best matching code for this product.
...
Consider material, form, value/weight thresholds, construction method.
...
def main():
    ...
    total = len(benchmark)
    print(f"\n{'='*60}")
    print(f"HYBRID v8 (GPT-4o, v2 structure, no feedback)")
    print(f"{'='*60}")
