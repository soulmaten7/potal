...
export const MATERIAL_OPTIONS = [
  ...
  { value: "synthetic-leather", label: "Synthetic Leather (PU/PVC)" },
  ...
  { value: "iron", label: "Iron / Cast Iron" },
  ...
  { value: "lithium-primary", label: "Lithium Primary (non-rechargeable)" },
...
export const MATERIAL_TO_CATEGORIES: Record<string, string[]> = {
  cotton: ['apparel-knit', 'apparel-woven', 'textiles-raw', 'footwear'],
  polyester: ['apparel-knit', 'apparel-woven', 'textiles-raw', 'footwear'],
  nylon: ['apparel-knit', 'apparel-woven', 'textiles-raw', 'footwear'],
  silk: ['apparel-knit', 'apparel-woven', 'textiles-raw', 'footwear'],
  wool: ['apparel-knit', 'apparel-woven', 'textiles-raw', 'footwear'],
  linen: ['apparel-knit', 'apparel-woven', 'textiles-raw', 'footwear'],
  leather: ['leather-goods', 'footwear', 'apparel-woven'],
  'synthetic-leather': ['leather-goods', 'footwear', 'apparel-woven'],
  rubber: ['footwear', 'toys', 'automotive-parts', 'machinery-industrial'],
  plastic: ['footwear', 'toys', 'automotive-parts', 'machinery-industrial'],
  steel: ['machinery-pumps', 'machinery-industrial', 'automotive-parts', 'furniture'],
  'stainless-steel': ['machinery-pumps', 'machinery-industrial', 'automotive-parts', 'furniture'],
  aluminum: ['machinery-pumps', 'machinery-industrial', 'automotive-parts', 'furniture'],
  copper: ['machinery-pumps', 'machinery-industrial', 'automotive-parts', 'furniture'],
  iron: ['machinery-pumps', 'machinery-industrial', 'automotive-parts', 'furniture'],
  titanium: ['machinery-pumps', 'machinery-industrial', 'automotive-parts', 'furniture'],
  gold: ['other'],
  silver: ['other'],
  glass: ['furniture', 'other'],
  ceramic: ['furniture', 'other'],
  wood: ['furniture', 'toys', 'other'],
  paper: ['other'],
  'lithium-ion': ['electronics-battery', 'electronics-consumer'],
  'lithium-primary': ['electronics-battery', 'electronics-consumer'],
  'carbon-fiber': ['automotive-parts', 'machinery-industrial'],
  other: [],
};
