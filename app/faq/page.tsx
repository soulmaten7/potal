...
const faqs: FAQ[] = [
  ...
  { category: 'API', question: 'What is the API rate limit?', answer: 'Rate limits depend on your plan: Free 30 req/min, Basic 60 req/min, Pro 300 req/min, Enterprise 1,000 req/min. Rate limit headers (X-RateLimit-Remaining) are included in all responses.' },
  // Pricing (5)
