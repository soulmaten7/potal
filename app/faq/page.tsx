...
const faqs: FAQ[] = [
  ...
  // API Usage (5)
  { category: 'API', question: 'How do I get an API key?', answer: 'Sign up at potal.app, go to Dashboard > API Keys, and click "Create Key". You\'ll get a publishable key (pk_live_) for client-side use and a secret key (sk_live_) for server-side use. The Forever Free plan includes 2,000 API calls per month.' },
  ...
  // Pricing (5)
  { category: 'Pricing', question: 'How much does POTAL cost?', answer: 'POTAL is Forever Free — $0/month with 2,000 API calls and access to all 140+ features. No credit card required. For enterprise-scale needs (50,000+ calls), contact us.' },
  { category: 'Pricing', question: 'Is there a free plan?', answer: 'POTAL is Forever Free — not just a free tier, but the entire platform at no cost. 2,000 API calls/month, all 140+ features included: HS classification, duty calculation, FTA detection, sanctions screening, and more. No credit card required.' },
  { category: 'Pricing', question: 'What happens if I exceed my plan limit?', answer: 'When you reach the 2,000 monthly call limit, API calls are paused until the next billing cycle. Need more? Contact us for Enterprise pricing.' },
  { category: 'Pricing', question: 'Is POTAL really free?', answer: 'Yes. POTAL is Forever Free — all 140+ features, 2,000 API calls/month, no credit card required, no trial period, no hidden charges. Enterprise customers with higher volume needs can contact us for custom pricing.' },
