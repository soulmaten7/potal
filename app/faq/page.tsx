...
const faqs: FAQ[] = [
  ...
  { category: 'HS Code', question: 'How does POTAL classify products to HS codes?', answer: 'POTAL uses a 3-stage AI classification pipeline: (1) Vector similarity search against 1,100+ pre-classified products, (2) Keyword matching against product descriptions, (3) LLM-based classification for novel products. Results are cached for instant future lookups at zero cost.' },
  { category: 'HS Code', question: 'How accurate is POTAL\'s HS code classification?', answer: 'POTAL achieves near-100% accuracy through a combination of curated product-to-HS mappings (1,055+ entries), vector similarity search, and LLM fallback. All classifications include confidence scores and reasoning chains for transparency.' },
  { category: 'HS Code', question: 'What is a tariff schedule?', answer: 'A tariff schedule is a country\'s official list of HS codes with corresponding duty rates. POTAL includes bulk-downloaded tariff schedules from 7 governments (US, EU, UK, KR, CA, AU, JP) covering 89,842 tariff lines.' },
  ...
  // API Usage (5)
  { category: 'API', question: 'How do I get an API key?', answer: 'Sign up at potal.app, go to Dashboard > API Keys, and click "Create Key". You\'ll get a publishable key (pk_live_) for client-side use and a secret key (sk_live_) for server-side use. The Free plan includes 200 API calls per month.' },
  { category: 'API', question: 'What endpoints does POTAL offer?', answer: 'POTAL offers 10+ endpoints: /calculate (landed cost), /classify (HS code), /validate (HS validation), /screening (sanctions), /export (CSV), /countries (profiles), /exchange-rate, /ioss, /customs-docs, /verify/pre-shipment, and more.' },
  { category: 'API', question: 'Is there a batch API?', answer: 'Yes. The /api/v1/classify/batch and /api/v1/import endpoints support batch processing. Limits: Free 50 items, Basic 100, Pro 500, Enterprise 5,000 per request.' },
  ...
  { category: 'API', question: 'What is the API rate limit?', answer: 'Rate limits depend on your plan: Free 10 req/min, Basic 60 req/min, Pro 300 req/min, Enterprise 1,000 req/min. Rate limit headers (X-RateLimit-Remaining) are included in all responses.' },
  // Pricing (5)
  { category: 'Pricing', question: 'How much does POTAL cost?', answer: 'Free: $0 (200 lookups/mo), Basic: $20/mo (2,000), Pro: $80/mo (10,000), Enterprise: $300/mo (50,000). Annual billing saves 20%. All plans include the same features — only volume differs.' },
  { category: 'Pricing', question: 'Is there a free plan?', answer: 'Yes. The Free plan includes 200 API lookups per month with access to all features: HS classification, duty calculation, FTA detection, sanctions screening, and more. No credit card required.' },
  { category: 'Pricing', question: 'What happens if I exceed my plan limit?', answer: 'Paid plans have overage pricing: Basic $0.015/lookup, Pro $0.012/lookup, Enterprise $0.01/lookup. Overages are billed at the end of the month. Free plan users are blocked at the limit.' },
  { category: 'Pricing', question: 'Do you offer annual billing?', answer: 'Yes. Annual billing saves 20%: Basic $192/yr ($16/mo), Pro $768/yr ($64/mo), Enterprise $2,880/yr ($240/mo). Volume commit pricing (100K+/mo) is available for Enterprise at $0.008/lookup.' },
  { category: 'Pricing', question: 'What payment methods do you accept?', answer: 'POTAL uses Paddle as our Merchant of Record, supporting credit/debit cards, PayPal, Apple Pay, Google Pay, and wire transfers for Enterprise plans. Paddle handles global tax compliance.' },
  // Troubleshooting (5)
  ...
  { category: 'Troubleshooting', question: 'Why is classification returning low confidence?', answer: 'Low confidence usually means the product description is too vague. Include specific details: material, intended use, size, and category. For example, "cotton t-shirt for men" is better than "shirt".' },
  ...
  { category: 'Compliance', question: 'Does POTAL check for dangerous goods?', answer: 'Yes. POTAL maintains a database of 50+ UN-classified dangerous goods mapped to HS codes. The calculate endpoint automatically flags dangerous goods with UN number, hazard class, and air/sea transport restrictions.' },
  // General (5)
  ...
  { category: 'General', question: 'How many countries does POTAL cover?', answer: 'POTAL covers all 240 countries and territories with VAT/GST rates, de minimis thresholds, and customs fees. MFN tariff data covers 186 countries (1M+ rates), with preferential rates for 53 countries (257M+ rows).' },
