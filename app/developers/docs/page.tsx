...
const ENDPOINTS: EndpointConfig[] = [
  {
    ...
    description: 'Calculate the total landed cost for a single item including import duties, taxes, customs fees, and the final price the buyer will pay. Supports 139+ countries with real-time exchange rates.',
    tag: 'Calculation',
    auth: true,
    fields: [
