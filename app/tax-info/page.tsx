    ...
    <div style={{ backgroundColor: '#ffffff' }} className="w-full min-h-screen pb-28">
      ...
      <div style={{ padding: '60px 24px 24px' }}>
        <div className="max-w-[1440px] mx-auto">
          ...
          >
            <Icons.ChevronLeft style={{ width: '20px', height: '20px', color: '#64748b' }} />
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 style={{ fontSize: '26px', fontWeight: 800, color: '#02122c', letterSpacing: '-0.02em' }}>
              {isImport ? 'Import Duty & Fees' : 'Sales Tax Info'}
            </h1>
          </div>
          <p style={{ fontSize: '14px', color: '#64748b', maxWidth: '600px', lineHeight: '1.6' }}>
            {isImport
            ...
            <>
              ...
              <div style={{ background: '#f8fafc', borderRadius: '16px', border: '1px solid #e2e8f0', padding: '24px' }}>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h2 style={{ fontSize: '18px', fontWeight: 800, color: '#02122c' }}>Import Duty (20%)</h2>
                </div>
                <p style={{ fontSize: '14px', color: '#475569', lineHeight: '1.8' }}>
                  ...
                  meaning all purchases from China-based retailers (<strong style={{ color: '#1e293b' }}>AliExpress, Temu, Shein</strong>) are now
              ...
              <div style={{ background: '#f8fafc', borderRadius: '16px', border: '1px solid #e2e8f0', padding: '24px' }}>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h2 style={{ fontSize: '18px', fontWeight: 800, color: '#02122c' }}>Merchandise Processing Fee (MPF)</h2>
                </div>
                <p style={{ fontSize: '14px', color: '#475569', lineHeight: '1.8' }}>
              ...
              <div style={{ background: '#f8fafc', borderRadius: '16px', border: '1px solid #e2e8f0', padding: '24px' }}>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h2 style={{ fontSize: '18px', fontWeight: 800, color: '#02122c' }}>Duty-Free Countries</h2>
                </div>
                <p style={{ fontSize: '14px', color: '#475569', lineHeight: '1.8' }}>
                  Orders from <strong style={{ color: '#1e293b' }}>South Korea, Japan, EU countries, and the UK</strong> remain
              ...
              <div style={{ background: '#f8fafc', borderRadius: '16px', border: '1px solid #e2e8f0', padding: '24px' }}>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h2 style={{ fontSize: '18px', fontWeight: 800, color: '#02122c' }}>How POTAL Calculates</h2>
                </div>
                ...
                <div style={{ background: '#f1f5f9', borderRadius: '12px', padding: '16px', fontFamily: 'monospace' }}>
                  <div style={{ fontSize: '13px', color: '#64748b', lineHeight: '2' }}>
                    <span style={{ color: '#94a3b8' }}>Product Price</span><br/>
                    <span style={{ color: '#ef4444' }}>+ Import Duty (20%)</span><br/>
                    <span style={{ color: '#ef4444' }}>+ MPF ($5.50)</span><br/>
                    <span style={{ color: '#94a3b8' }}>+ Shipping</span><br/>
                    <div style={{ borderTop: '1px dashed #e2e8f0', margin: '4px 0' }} />
                    <strong style={{ color: '#02122c', fontSize: '14px' }}>= Total Landed Cost</strong>
                  </div>
                </div>
              </div>
            ...
            <>
              ...
              <div style={{ background: '#f8fafc', borderRadius: '16px', border: '1px solid #e2e8f0', padding: '24px' }}>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h2 style={{ fontSize: '18px', fontWeight: 800, color: '#02122c' }}>Estimated Sales Tax (~7%)</h2>
                </div>
                <p style={{ fontSize: '14px', color: '#475569', lineHeight: '1.8' }}>
                  ...
                  Texas ~8.25%, while <strong style={{ color: '#1e293b' }}>Oregon, Montana, Delaware, and New Hampshire have 0% sales tax</strong>.
                </p>
              </div>
              ...
              <div style={{ background: '#f8fafc', borderRadius: '16px', border: '1px solid #e2e8f0', padding: '24px' }}>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h2 style={{ fontSize: '18px', fontWeight: 800, color: '#02122c' }}>How It Works</h2>
                </div>
                <p style={{ fontSize: '14px', color: '#475569', lineHeight: '1.8' }}>
                  When you enter your <strong style={{ color: '#1e293b' }}>ZIP code</strong> in POTAL settings,
              ...
              <div style={{ background: '#f8fafc', borderRadius: '16px', border: '1px solid #e2e8f0', padding: '24px' }}>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h2 style={{ fontSize: '18px', fontWeight: 800, color: '#02122c' }}>Tax-Free Shopping</h2>
                </div>
                <p style={{ fontSize: '14px', color: '#475569', lineHeight: '1.8' }}>
                  Five states have no sales tax: <strong style={{ color: '#1e293b' }}>Oregon, Montana, Delaware,
...
export default function TaxInfoPage() {
  return (
    <Suspense fallback={<div style={{ backgroundColor: '#ffffff' }} className="min-h-screen flex items-center justify-center"><span style={{ color: '#94a3b8' }}>Loading...</span></div>}>
      <TaxInfoContent />
    </Suspense>
  );
}
