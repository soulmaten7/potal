  ...
  'terms': {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'API access is subject to rate limits based on your subscription plan: Free (500 calls/month), Starter (5,000 calls/month), Growth (25,000 calls/month), and Enterprise (custom). Exceeding your plan limits may result in throttled or blocked requests until the next billing cycle.',
      },
      {
