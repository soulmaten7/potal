...
/** Map feature slug → features detail page with #try-it anchor */
const TOOL_LINKS: Record<string, string> = {
  'hs-code-classification':    '/features/hs-code-classification#try-it',
  'duty-rate-calculation':     '/features/duty-rate-calculation#try-it',
  'tax-calculation-vat-gst':   '/features/tax-calculation-vat-gst#try-it',
  'total-landed-cost':         '/features/duty-rate-calculation#try-it',
  'confidence-score':          '/features/confidence-score#try-it',
  'de-minimis-check':          '/features/de-minimis-rules#try-it',
  'batch-classification':      '/features/batch-classification#try-it',
  'image-classification':      '/features/image-classification#try-it',
  'currency-conversion':       '/features/currency-exchange#try-it',
  'audit-trail':               '/features/audit-trail#try-it',
  'price-break-rules':         '/features/price-break-rules#try-it',
  'restricted-items':          '/features/restricted-items#try-it',
  'sanctions-screening':       '/features/sanctions-screening#try-it',
  'denied-party-screening':    '/features/sanctions-screening#try-it',
  'export-controls':           '/features/export-control-classification#try-it',
  'anti-dumping-duties':       '/features/anti-dumping-duties#try-it',
  'countervailing-duties':     '/features/anti-dumping-duties#try-it',
  'safeguard-measures':        '/features/anti-dumping-duties#try-it',
  'fta-detection':             '/features/fta-detection#try-it',
  'rules-of-origin':           '/features/fta-detection#try-it',
  'preferential-rates':        '/features/fta-detection#try-it',
  'ioss-registration':         '/features/ioss-vat-calculation#try-it',
  'vat-registration-check':    '/features/vat-gst-registration-check#try-it',
  'ddp-ddu-calculator':        '/features/ddp-ddu-comparison#try-it',
  'customs-documentation':     '/features/customs-documentation#try-it',
  'dangerous-goods':           '/features/dangerous-goods#try-it',
  'shipping-rates':            '/features/shipping-cost-estimation#try-it',
  'compliance-report':         '/features/compliance-check#try-it',
  'trade-embargo-check':       '/features/trade-embargo-check#try-it',
  'pre-shipment-check':        '/features/pre-shipment-check#try-it',
  'eccn-classification':       '/features/export-control-classification#try-it',
  'compare-origins':           '/features/compare-origins#try-it',
};
