...
export const metadata: Metadata = {
  ...
  description: "Calculate duties, taxes, and shipping for 240 countries in real-time. The infrastructure for global e-commerce — embed our widget or REST API.",
  ...
  openGraph: {
    ...
    description: "Calculate duties, taxes, and shipping for 240 countries in real-time. The infrastructure for global e-commerce.",
    url: "https://potal.app",
    locale: "en_US",
    images: [
      {
