...
| D5 | Product & Web | potal.app 전체: 랜딩, 가격표, 대시보드, Features 페이지(검색박스 추가 CW22-F), 로그인/가입, i18n 51개국어 UI, CWV. Forever Free 전면 적용(Developers/Dashboard/FAQ/Blog CW22-G) | 3 | app/, components/ |
...
| D12 | Marketing & Partnerships | Content/SEO, 소셜 미디어, 이메일 캠페인, 파트너십(1400+), Product Hunt. content/ 폴더 + Demo Scripts 엑셀 18개 메뉴(CW22-H). Notion Content Pipeline 관리로 전환(CW22-J) | **4** (+1) | content/, marketing/ |
