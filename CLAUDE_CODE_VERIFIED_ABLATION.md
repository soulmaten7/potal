...
- `/Users/maegbug/portal/POTAL_Ablation_V2.xlsx`
...
portal 폴더에 최종 엑셀 복사:
```bash
cp /Volumes/soulmaten/POTAL/7field_benchmark/POTAL_Ablation_V2.xlsx /Users/maegbug/portal/POTAL_Ablation_V2.xlsx 2>/dev/null || true
```
